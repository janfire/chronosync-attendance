    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <dl class="space-y-3">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ Auth::user()->employee_number }}</dd>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <dl class="space-y-3">
                    ...
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Biometric Enrollment</dt>
                        <dd class="mt-1">
        ...
        <div class="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div class="h-10 w-10 rounded-lg bg-green-100 flex items-center justify-center">
                        <i class="fas fa-chart-line text-green-600"></i>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-900">Dashboard</p>
                        <p class="text-xs text-gray-500">Go to dashboard</p>
                    </div>
                </a>
                
                @if(Auth::user()->canManageUsers())
                <a href="{{ route('admin.users.index') }}" class="flex items-center space-x-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
