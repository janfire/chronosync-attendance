        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 dark:bg-gray-800 dark:border-gray-700">
            <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2 dark:text-gray-200">
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2 dark:text-gray-200">
                            ...
                            @error('email')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Must be a @example.com email address</p>
                        </div>

                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 dark:bg-gray-900 dark:border-gray-700">
                            <p class="text-sm text-gray-600 dark:text-gray-300">
                                <strong>Employee Number:</strong> {{ $user->employee_number }}
                            </p>
                            <p class="text-xs text-gray-500 mt-1 dark:text-gray-400">Employee number cannot be changed. Contact an administrator if you need to update it.</p>
                        </div>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <p class="text-xs text-gray-500 mt-1 dark:text-gray-400">Role cannot be changed. Contact an administrator if you need a role change.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-6 dark:border-gray-700">
                    ...
                    <p class="text-sm text-gray-600 mb-4 dark:text-gray-300">Leave password fields blank if you don't want to change your password.</p>
                    
                    <div class="space-y-4">
                        <div>
                            <label for="current_password" class="block text-sm font-medium text-gray-700 mb-2 dark:text-gray-200">
                                Current Password
                            </label>
                            <input 
                                type="password" 
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2 dark:text-gray-200">
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('profile.show') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors dark:bg-gray-900 dark:text-gray-200">
                        Cancel
                    </a>
