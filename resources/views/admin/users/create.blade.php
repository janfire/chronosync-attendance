    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-md border border-gray-200 px-8 py-7 sm:px-10">
            <div class="mb-6 border-b border-gray-100 pb-5">
                <p class="text-sm font-semibold text-emerald-700">Admin / Users / Create</p>
                <h3 class="mt-1 text-xl font-semibold text-gray-900">Create a staff account</h3>
                <p class="mt-2 text-sm text-gray-600">Fill out all required fields below to create a new user profile.</p>
            </div>
