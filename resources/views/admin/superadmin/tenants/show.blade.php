    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const dtConfig = {
            ...
            drawCallback: function() {
                // Style the select and input generated by DataTables
        ...
        $('#usersTable').DataTable(Object.assign({}, dtConfig, { order: [[3, 'desc']] }));
        $('#invoicesTable').DataTable(Object.assign({}, dtConfig, { order: [[3, 'desc']] }));
    });
