    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form action="{{ route('superadmin.plans.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:bg-gray-900 dark:border-gray-600 dark:text-white" placeholder="e.g., Pro Tier">
                @error('name')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="price_usd" id="price_usd" value="{{ old('price_usd') }}" required class="w-full pl-8 rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:bg-gray-900 dark:border-gray-600 dark:text-white">
                    </div>
                    @error('price_usd')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="max_employees" id="max_employees" value="{{ old('max_employees') }}" required class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:bg-gray-900 dark:border-gray-600 dark:text-white">
            ...
            <div class="mb-6">
                ...
                <input type="number" name="trial_days" id="trial_days" value="{{ old('trial_days', 14) }}" required class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:bg-gray-900 dark:border-gray-600 dark:text-white">
                @error('trial_days')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="features" id="features" rows="3" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:bg-gray-900 dark:border-gray-600 dark:text-white" placeholder="Advanced Reports, QR Code Attendance, Slack Integration">{{ old('features') }}</textarea>
