        ...
        <form action="{{ route('superadmin.announcements.store') }}" method="POST" class="p-6 sm:p-8">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required class="w-full pl-10 rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:bg-gray-900 dark:border-gray-600 dark:text-white transition-colors" placeholder="e.g., Scheduled System Maintenance">
                </div>
                @error('title')
